...
public class Task5_CourseMaintainance implements java.io.Serializable {
	String courseName;
	String courseID;
	int maxStudents;
	int currentStudents;
	...
	static ArrayList<Task5_CourseMaintainance> courseList = new ArrayList<Task5_CourseMaintainance>();

	Task5_CourseMaintainance() {

	}

	Task5_CourseMaintainance(String courseName, String courseID, int maxStudents, int currentStudents, String instructorName,
	...
	public static void deSerialization() {
		try {
			...
			courseList = (ArrayList<Task5_CourseMaintainance>) ois.readObject();
			ois.close();
			fis.close();
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		if (!fileName.exists()) {
			fileName = new File("resources/MyUniversityCourses.csv");
			...
			while (strTokens.hasMoreTokens()) {
				if (count > 7) {
					...
					Task5_CourseMaintainance c = new Task5_CourseMaintainance(courseName, courseID, maxStudents, currentStudents, instructorName,
